...
func main() {
	...
	FileMenu := AppMenu.AddSubmenu("NukemKB Lite")
	FileMenu.AddText("About NukemKB", keys.CmdOrCtrl("i"), func(_ *menu.CallbackData) {
		if app.ctx == nil {
			return
		}
