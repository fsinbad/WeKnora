...
const MESSAGES = {
  zh: {
    ...
    navChat: "问答",
    navSettings: "设置",
    knowledgeTitle: "NukemKB 知识库",
    knowledgeSubtitle: "在微信中选择知识库，导入网页或提问。",
    needsSettings: "请先配置 NukemKB API 地址和 API Key，再加载知识库。",
    openSettings: "打开设置",
    knowledgeBase: "知识库",
    tapToSelect: "点击选择",
    ...
    importFailed: "导入失败",
    chatTitle: "知识问答",
    chatSubtitle: "向当前选中的 NukemKB 知识库提问。",
    question: "问题",
    questionPlaceholder: "输入你的问题…",
    askWeKnora: "向 NukemKB 提问",
    answer: "回答",
    chatFailed: "问答失败",
    sessionIdMissing: "会话接口未返回 session id。",
    settingsTitle: "连接 NukemKB",
    settingsSubtitle: "填写 NukemKB API 地址与租户 API Key。",
    apiBaseUrl: "API 地址",
    apiBaseUrlPlaceholder: "https://your-nukemkb.example.com",
    apiKey: "API Key",
    ...
    saveSettings: "保存设置",
    saved: "已保存",
    missingBaseUrl: "请先配置 NukemKB API 地址。",
    missingApiKey: "请先配置 NukemKB API Key。"
  },
  en: {
    ...
    knowledgeTitle: "NukemKB Knowledge",
    knowledgeSubtitle: "Import a web page into a selected knowledge base from WeChat.",
    needsSettings: "Configure the NukemKB API base URL and API key before loading knowledge bases.",
    ...
    chatSubtitle: "Ask the selected NukemKB knowledge base.",
    question: "Question",
    questionPlaceholder: "Ask something...",
    askWeKnora: "Ask NukemKB",
    answer: "Answer",
    chatFailed: "Chat failed",
    sessionIdMissing: "The session API did not return a session id.",
    settingsTitle: "Connect NukemKB",
    settingsSubtitle: "Use your NukemKB API endpoint and tenant API key.",
    ...
    saved: "Saved",
    missingBaseUrl: "Please configure the NukemKB API base URL first.",
    missingApiKey: "Please configure the NukemKB API key first."
  }
};
