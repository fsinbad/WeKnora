  ...
  settings: {
    ...
    sandbox: {
      ...
      backendDescriptions: {
        ...
        local: '直接在 NukemKB 服务进程所在环境执行脚本',
      },
      addConfig: '添加沙箱后端',
      ...
      localRuntimeWarning: '本地进程会直接在 NukemKB 服务器上执行技能脚本，不具备容器或 MicroVM 隔离。仅建议在可信的开发空间使用。',
      ...
      templateStepHint: '集群缺少标准模板时，NukemKB 会自动创建；模板就绪后才能继续。',
