  ...
  settings: {
    ...
    sandbox: {
      ...
      backendDescriptions: {
        ...
        local: 'Run scripts directly in the NukemKB server process environment',
      },
      ...
      localRuntimeWarning: 'Local process runs skill scripts directly on the NukemKB server without container or MicroVM isolation. Use only in a trusted development workspace.',
      ...
      localRuntimeSummary: 'NukemKB server process',
      ...
      templateLoadHint: 'Enter the cluster connection and refresh. NukemKB creates its standard template when missing.',
      ...
      templateStepHint: 'NukemKB automatically creates its standard template when missing. You can continue after a template is ready.',
