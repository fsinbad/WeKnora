export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      backendDescriptions: {
        ...
        docker: 'Keep a long-lived container per session on this NukemKB host; scripts and files stay in that container',
      },
      ...
      templateLoadHint: 'Enter the cluster connection and refresh. If there is no NukemKB standard template, click Create; after changing DNS or the image, click Delete and rebuild.',
      ...
      templateStepHint: 'This step only lists templates already on the cluster; it does not create one automatically. Click Create NukemKB standard template if none exists, or Delete and rebuild after changing DNS or the image. You can continue after a template is ready.',
      ...
      templateUntaggedHint: 'The builds finished but none carries the default tag, so sandbox creation cannot resolve this template. Delete it in E2B and refresh; NukemKB will rebuild it.',
      templateFailedReason: 'Build failed: {reason}',
      noTemplates: 'No templates were returned by this cluster.',
      weknoraStandardTemplate: 'NukemKB standard template',
      ...
      replaceStandardTemplateConfirm: 'Rebuild the NukemKB standard template with the current settings, including DNS. The previous spawnable template is not deleted until the replacement is ready.',
  ...
  envVarSettings: {
    ...
    description: 'Personal keys for skills and sandboxes, not NukemKB system or deployment settings.',
  ...
  auth: {
    ...
    registerSubtitle: 'Create your account and start using NukemKB',
  ...
  integrations: {
    ...
    chrome: {
      ...
      subtitle: 'For self-hosted NukemKB: ask questions in a sidebar, clip web pages, and save Markdown notes into your knowledge bases while you browse.',
    ...
    claw: {
      title: 'NukemKB Skill',
      subtitle: 'Import documents and run hybrid retrieval (vector + keyword) via the NukemKB REST API—for uploads, URL imports, Markdown entries, and cross-KB search.',
