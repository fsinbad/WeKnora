...
const exampleData: FAQEntryPayload[] = [
  {
    standard_question: '什么是 NukemKB？',
    answers: ['NukemKB 是一个智能知识库管理系统', '它支持多种知识库类型和导入方式'],
    similar_questions: ['NukemKB 是什么？', '介绍一下 NukemKB'],
    negative_questions: ['这不是 NukemKB', '与 NukemKB 无关'],
    tag_name: '产品介绍',
  },
  {
